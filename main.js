...
console.log(sketch);
update_sketch = document.getElementById("given_sketch").innerHTML = "Sketch To Be Drawn: " + sketch;
...
function check_sketch() {
    ...
    document.getElementById("time_taken").innerHTML = "Timer: " + timer_counter;
